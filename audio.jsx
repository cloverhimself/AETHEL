/* AETHEL — Procedural ambient drone via Web Audio API.
   Generates a slow, deep cosmic pad — no audio files needed. */
...
function AmbientAudio() {
  ...
  const start = async () => {
    ...
    // Reverb-ish: short feedback delay
    ...
    // Drone chord — A minor 9 (low octave), with detuning
    const baseFreqs = [55, 82.4, 110, 130.8, 164.8]; // A1, E2, A2, C3, E3
    const oscs = [];
    ...
    // Occasional shimmer — random high bell
    const bellTick = () => {
