/* AETHEL — Lineages, Great Rupture, Seals */
  ...
  return (
    <section className="section" id="lineages" data-screen-label="04 Lineages">
      <div className="shell">
          ...
          <div className="carousel__track" ref={trackRef}>
            {LINEAGES.map((l, i) => (
              ...
              >
                ...
                <div className="lineage-card__visual placeholder-art" style={{ '--accent-deep': 'var(--' + l.id + '-deep)' }}>
                  <LineageSigil id={l.id} />
                  <span className="placeholder-art__label">{l.name.toUpperCase()} · ART REF</span>
                </div>
        ...
        {/* Marquee strip with all five names */}
        ...
        <div className="rupture">
          {RUPTURE.map((r, i) => (
            <div key={i} className="rupture__step reveal" data-delay={(i % 4)}>
              <div className="rupture__dot" style={{ background: i === 5 ? 'var(--noctyra)' : i === 0 ? 'var(--gold)' : 'var(--gold)' }} />
...
Object.assign(window, { LineagesSection, RuptureSection, SealsSection });
