/* AETHEL — Find Your Soul quiz.
   6 short questions. Each answer scores a lineage and a seal.
   Result: one of the 20 echelons. */
...
function FindYourSoul() {
  ...
  const [revealText, setRevealText] = React.useState(false);
  ...
  return (
    <>
      {/* Inline call-to-action — placed near identity section via app */}
...
window.FindYourSoul = FindYourSoul;
